...
\end{center}
\caption[Overview of metabolic network reconstruction protocol]{Overview of metabolic network reconstruction protocol \cite{chen2012metabolic}.}
\vskip\baselineskip % Leave a vertical skip below the figure
