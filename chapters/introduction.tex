...
%\begin{figure}[H]
%\begin{center}
%\includegraphics[width=0.85\columnwidth]{figures/intro_alesim.jpg}
...
\end{center}
\caption[Systems biology approaches. Bottom-up approach on the left, top-down approach on the right triangle\cite{kremling2013systems}.]{Systems biology approaches. Bottom-up approach on the left, top-down approach on the right triangle\cite{kremling2013systems}.}
...
\end{center}
\caption[Overview of metabolic network reconstruction protocol \cite{chen2012metabolic}.]{Overview of metabolic network reconstruction protocol \cite{chen2012metabolic}.}
\vskip\baselineskip % Leave a vertical skip below the figure
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.8\columnwidth]{figures/intro_wos.png}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.7\columnwidth]{figures/intro_toymodel.png}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.8\columnwidth]{figures/intro_constraintbasedmodelling.png}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.9\columnwidth]{figures/intro_yeastgemschronology.png}
